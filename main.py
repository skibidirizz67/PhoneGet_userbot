...
logging.basicConfig(filename=c.log_path, filemode='a', format='[%(asctime)s] [%(levelname)s]: %(message)s', level=logging.INFO)
...
client.loop.run_until_complete(c.getme())
